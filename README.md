...
<body class="p-4 md:p-8">
    <div id="invoice-content" class="invoice-container max-w-5xl mx-auto p-6 rounded-lg">
        ...
        <div class="flex justify-end space-x-4 no-print">
            <button id="download-pdf-btn" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded flex items-center">
    ...
    <script>
        ...
        function calculateTotals() {
            ...
            const adminTotal = Math.round(staffTotal * 0.13);
